...
public class TheftPage extends AppCompatActivity implements View.OnClickListener {
    private final AppCompatActivity activity = TheftPage.this;
    GPSTracker gps;
    ...
    private String str;
    private String url = "https://dps.usc.edu/safety-tips/theft-prevention/";

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_theft_page);
        getSupportActionBar().hide();


        firebut = (TextView) findViewById(R.id.thefttrigger);
        accidentbut = (TextView) findViewById(R.id.theftlinkview);
        gps = new GPSTracker(TheftPage.this);
